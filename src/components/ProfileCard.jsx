            ...
            >
              ...
              {showUserInfo && (
                ...
                >
                  ...
                  <button
                    className="border border-white/10 rounded-lg px-3 py-1.5 text-xs font-semibold text-white/90 cursor-pointer backdrop-blur-[10px] transition-all duration-200 ease-out hover:border-white/40 hover:-translate-y-px whitespace-nowrap"
