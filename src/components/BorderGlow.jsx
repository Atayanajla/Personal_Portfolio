  ...
  return (
    <div
      ...
      style={{
        ...
        boxShadow:
          "rgba(59,130,246,0.15) 0 1px 2px, rgba(59,130,246,0.15) 0 2px 4px, rgba(59,130,246,0.15) 0 4px 8px, rgba(59,130,246,0.15) 0 8px 16px, rgba(59,130,246,0.15) 0 16px 32px, rgba(59,130,246,0.15) 0 32px 64px",
      }}
    >
